...
app.Use(async (context, next) =>
{
    ...
    {
        app.Logger.LogWarning(ex, "LogisticsTracking dependency call failed.");
        await WriteErrorAsync(
            context,
    ...
    {
        app.Logger.LogWarning(ex, "LogisticsTracking dependency call timed out.");
        await WriteErrorAsync(
            context,
    ...
    {
        app.Logger.LogError(ex, "Unhandled LogisticsTracking API exception for {Method} {Path}", context.Request.Method, context.Request.Path);
        await WriteErrorAsync(
            context,
