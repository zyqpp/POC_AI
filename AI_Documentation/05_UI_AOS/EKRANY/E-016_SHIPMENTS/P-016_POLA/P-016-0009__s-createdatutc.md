...
**Co wyświetla / zbiera:** Data i godzina utworzenia shipmentu. Używana do sortowania malejącego przy ładowaniu.
**Źródło danych:** ShipmentDto.createdAtUtc → Shipments.CreatedAtUtc  
**Kiedy widoczne:** W każdym wierszu tabeli.
**Format:** ISO 8601 UTC string; wyświetlany przez 	oLocaleDateString.
...
|---|---|---|---|
| Frontend model/form | ShipmentDto.createdAtUtc | `createdAtUtc: string` | `wniosek z analizy` |
| Endpoint | LogisticsApiService (rola-zależny) | `GET /logistics/api/logistics/shipments[/my|/assigned]` | `potwierdzone` |
| DTO/kontrakt | ShipmentDto | `public string CreatedAtUtc { get; }` | `wniosek z analizy` |
...
- [TD dla pola](../TD-016_DANE_TESTOWE/TD-016-0009__s-createdatutc.md)
