...
**Co wyświetla / zbiera:** Etykieta opcji w dropdownie filtra statusu (np. 'Created', 'In Transit', 'Delivered'). Z statusOptions w komponencie.
**Źródło danych:** Lokalny SHIPMENT_STATUS_LABELS.
**Kiedy widoczne:** W dropdownie statusFilter.
**Format:** Ciąg znaków.
...
- [TD dla pola](../TD-016_DANE_TESTOWE/TD-016-0004__s-label.md)
