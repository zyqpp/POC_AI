# ERR-019-0003 Reminder state saved, but notification dispatch failed
...
| Atrybut | Wartość |
|---|---|
| ID błędu | `ERR-019-0003` |
| Ekran | [E-019](../E-019__README.md) |
| Nazwa wykryta | `Reminder state saved, but notification dispatch failed` |
