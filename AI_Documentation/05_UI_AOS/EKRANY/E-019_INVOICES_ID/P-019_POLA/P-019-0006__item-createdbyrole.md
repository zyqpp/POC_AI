...
| Nazwa wykryta | `item.createdByRole` |
...
| Typ UI | do uzupełnienia | `supply-chain-frontend/src/app/features/payments/invoice-detail/invoice-detail.component.html` |
| Reguły walidacji | do uzupełnienia | brak pełnej analizy walidatorów |
| Komunikaty błędów | [ERR-019](../ERR-019_BLEDY/ERR-019__INDEX.md) | do uzupełnienia |
...
- [TD dla pola](../TD-019_DANE_TESTOWE/TD-019-0006__item-createdbyrole.md)
