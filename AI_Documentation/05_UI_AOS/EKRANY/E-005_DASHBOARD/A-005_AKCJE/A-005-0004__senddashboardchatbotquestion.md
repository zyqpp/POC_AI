# A-005-0004 sendDashboardChatbotQuestion
...
| Nazwa wykryta | `sendDashboardChatbotQuestion` |
| Typ detekcji | `click` |
...
- [Macierz testów ekranu](../TC-005_TESTY/TC-005__INDEX.md)
- Dane wejściowe: do uzupełnienia.
- Oczekiwany rezultat: do uzupełnienia.

## Linki

- [Indeks akcji](A-005__INDEX.md)
- [Pola ekranu](../P-005_POLA/P-005__INDEX.md)
