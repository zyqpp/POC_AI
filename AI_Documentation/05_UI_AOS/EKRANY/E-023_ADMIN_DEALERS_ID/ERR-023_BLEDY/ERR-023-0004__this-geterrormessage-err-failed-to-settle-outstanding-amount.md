# ERR-023-0004 this.getErrorMessage(err, 'Failed to settle outstanding amount
...
| Atrybut | Wartość |
|---|---|
| ID błędu | `ERR-023-0004` |
| Ekran | [E-023](../E-023__README.md) |
| Nazwa wykryta | `this.getErrorMessage(err, 'Failed to settle outstanding amount` |
| Typ detekcji | `toast.error` |
| Źródło | `supply-chain-frontend/src/app/features/admin/dealer-detail/dealer-detail.component.ts` |
...
- [Indeks błędów](ERR-023__INDEX.md)
