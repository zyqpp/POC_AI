# ERR-023-0003 this.getErrorMessage(err, 'Failed to update credit limit
...
| Atrybut | Wartość |
|---|---|
| ID błędu | `ERR-023-0003` |
| Ekran | [E-023](../E-023__README.md) |
| Nazwa wykryta | `this.getErrorMessage(err, 'Failed to update credit limit` |
