...
| Typ UI | do uzupełnienia | `supply-chain-frontend/src/app/features/auth/register/register.component.html` |
| Reguły walidacji | do uzupełnienia | brak pełnej analizy walidatorów |
| Komunikaty błędów | [ERR-002](../ERR-002_BLEDY/ERR-002__INDEX.md) | do uzupełnienia |
...
- [TD dla pola](../TD-002_DANE_TESTOWE/TD-002-0007__tradelicenseno.md)
- Zakres danych poprawnych: do uzupełnienia.
- Zakres danych błędnych: do uzupełnienia.

## Linki

- [Indeks pól](P-002__INDEX.md)
- [Akcje ekranu](../A-002_AKCJE/A-002__INDEX.md)
