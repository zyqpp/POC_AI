# P-020-0006 isChannelEnabledInDraft(NotificationChannel.Sms)
...
| Nazwa wykryta | `isChannelEnabledInDraft(NotificationChannel.Sms)` |
...
- [TD dla pola](../TD-020_DANE_TESTOWE/TD-020-0006__ischannelenabledindraft-notificationchannel-sms.md)
