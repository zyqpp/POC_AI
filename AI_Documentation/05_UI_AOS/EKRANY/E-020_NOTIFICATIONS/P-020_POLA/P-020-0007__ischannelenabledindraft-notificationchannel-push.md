# P-020-0007 isChannelEnabledInDraft(NotificationChannel.Push)
...
| Nazwa wykryta | `isChannelEnabledInDraft(NotificationChannel.Push)` |
...
- [TD dla pola](../TD-020_DANE_TESTOWE/TD-020-0007__ischannelenabledindraft-notificationchannel-push.md)
