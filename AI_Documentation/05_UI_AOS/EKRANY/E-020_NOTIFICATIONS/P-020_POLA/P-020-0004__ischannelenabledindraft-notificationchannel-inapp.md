# P-020-0004 isChannelEnabledInDraft(NotificationChannel.InApp)
...
| Nazwa wykryta | `isChannelEnabledInDraft(NotificationChannel.InApp)` |
...
| Typ UI | do uzupełnienia | `supply-chain-frontend/src/app/features/notifications/notification-list/notification-list.component.html` |
| Reguły walidacji | do uzupełnienia | brak pełnej analizy walidatorów |
| Komunikaty błędów | [ERR-020](../ERR-020_BLEDY/ERR-020__INDEX.md) | do uzupełnienia |
...
- [TD dla pola](../TD-020_DANE_TESTOWE/TD-020-0004__ischannelenabledindraft-notificationchannel-inapp.md)
- Zakres danych poprawnych: do uzupełnienia.
- Zakres danych błędnych: do uzupełnienia.

## Linki

- [Indeks pól](P-020__INDEX.md)
