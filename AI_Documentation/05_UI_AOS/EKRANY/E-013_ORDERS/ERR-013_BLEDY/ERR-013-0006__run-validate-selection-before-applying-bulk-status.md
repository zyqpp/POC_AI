# ERR-013-0006 Run Validate Selection before applying bulk status
...
| Atrybut | Wartość |
|---|---|
| ID błędu | `ERR-013-0006` |
| Ekran | [E-013](../E-013__README.md) |
| Nazwa wykryta | `Run Validate Selection before applying bulk status` |
| Typ detekcji | `toast.warning` |
| Źródło | `supply-chain-frontend/src/app/features/orders/order-list/order-list.component.ts` |
...
- [Indeks błędów](ERR-013__INDEX.md)
