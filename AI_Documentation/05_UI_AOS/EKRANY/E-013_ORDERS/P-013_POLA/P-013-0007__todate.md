...
**Co wyświetla / zbiera:** Data końcowa zakresu filtrowania po placedAtUtc (kliencki). Porównuje 
ew Date(order.placedAtUtc) <= to (setHours 23,59,59,999).
...
- [TD dla pola](../TD-013_DANE_TESTOWE/TD-013-0007__todate.md)
