# P-011-0001 Add handling or delivery note
...
| Nazwa wykryta | `Add handling or delivery note` |
| Typ detekcji | `placeholder` |
| Źródło | `supply-chain-frontend/src/app/features/cart/cart.component.html` |
...
| Typ UI | do uzupełnienia | `supply-chain-frontend/src/app/features/cart/cart.component.html` |
| Reguły walidacji | do uzupełnienia | brak pełnej analizy walidatorów |
| Komunikaty błędów | [ERR-011](../ERR-011_BLEDY/ERR-011__INDEX.md) | do uzupełnienia |
...
- [TD dla pola](../TD-011_DANE_TESTOWE/TD-011-0001__add-handling-or-delivery-note.md)
- Zakres danych poprawnych: do uzupełnienia.
- Zakres danych błędnych: do uzupełnienia.

## Linki

- [Indeks pól](P-011__INDEX.md)
- [Akcje ekranu](../A-011_AKCJE/A-011__INDEX.md)
- [Ślad ekranu](../E-011__LINKI.md)
