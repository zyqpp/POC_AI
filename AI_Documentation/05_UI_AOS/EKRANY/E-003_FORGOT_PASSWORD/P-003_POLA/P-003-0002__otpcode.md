...
| Typ UI | do uzupełnienia | `supply-chain-frontend/src/app/features/auth/forgot-password/forgot-password.component.html` |
| Reguły walidacji | do uzupełnienia | brak pełnej analizy walidatorów |
| Komunikaty błędów | [ERR-003](../ERR-003_BLEDY/ERR-003__INDEX.md) | do uzupełnienia |
...
- [TD dla pola](../TD-003_DANE_TESTOWE/TD-003-0002__otpcode.md)
