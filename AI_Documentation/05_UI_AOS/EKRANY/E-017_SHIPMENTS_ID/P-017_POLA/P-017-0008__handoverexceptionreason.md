# P-017-0008 handoverExceptionReason
...
| Nazwa wykryta | `handoverExceptionReason` |
| Typ detekcji | `[(ngModel)]` |
| Źródło | `supply-chain-frontend/src/app/features/logistics/shipment-detail/shipment-detail.component.html` |
...
| Typ UI | do uzupełnienia | `supply-chain-frontend/src/app/features/logistics/shipment-detail/shipment-detail.component.html` |
| Reguły walidacji | do uzupełnienia | brak pełnej analizy walidatorów |
| Komunikaty błędów | [ERR-017](../ERR-017_BLEDY/ERR-017__INDEX.md) | do uzupełnienia |
...
- [TD dla pola](../TD-017_DANE_TESTOWE/TD-017-0008__handoverexceptionreason.md)
- Zakres danych poprawnych: do uzupełnienia.
- Zakres danych błędnych: do uzupełnienia.

## Linki

- [Indeks pól](P-017__INDEX.md)
- [Akcje ekranu](../A-017_AKCJE/A-017__INDEX.md)
- [Ślad ekranu](../E-017__LINKI.md)
