# ERR-014-0004 Failed to update shipment status
...
| Atrybut | Wartość |
|---|---|
| ID błędu | `ERR-014-0004` |
| Ekran | [E-014](../E-014__README.md) |
| Nazwa wykryta | `Failed to update shipment status` |
| Typ detekcji | `toast.error` |
| Źródło | `supply-chain-frontend/src/app/features/orders/order-tracking/order-tracking.component.ts` |
...
- [Indeks błędów](ERR-014__INDEX.md)
