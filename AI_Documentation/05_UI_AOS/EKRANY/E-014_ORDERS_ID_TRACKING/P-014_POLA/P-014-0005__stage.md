...
**Co wyświetla / zbiera:** Etykieta etapu postępu zamówienia (np. 'Placed', 'Processing', 'Dispatch', 'Transit', 'Delivered') w pasku etapów.
**Źródło danych:** Lokalny array orderStages w komponencie.
**Kiedy widoczne:** Zawsze (pasek etapów zamówienia).
**Format:** Ciąg znaków.
...
- [TD dla pola](../TD-014_DANE_TESTOWE/TD-014-0005__stage.md)
