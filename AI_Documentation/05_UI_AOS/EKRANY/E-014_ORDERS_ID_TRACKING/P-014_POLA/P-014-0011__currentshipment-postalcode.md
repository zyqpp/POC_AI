# P-014-0011 currentShipment.postalCode
...
| Nazwa wykryta | `currentShipment.postalCode` |
...
**Co wyświetla / zbiera:** Kod pocztowy dostawy.
**Źródło danych:** ShipmentDto.postalCode → Shipments.PostalCode  
**Kiedy widoczne:** Gdy selectedShipment() !== null.
**Format:** Ciąg znaków (max 12).
...
- [TD dla pola](../TD-014_DANE_TESTOWE/TD-014-0011__currentshipment-postalcode.md)
