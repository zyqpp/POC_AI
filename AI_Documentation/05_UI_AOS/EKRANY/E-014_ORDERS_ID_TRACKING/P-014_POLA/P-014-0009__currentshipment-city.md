# P-014-0009 currentShipment.city
...
| Nazwa wykryta | `currentShipment.city` |
...
**Co wyświetla / zbiera:** Miasto dostawy wybranego shipmentu.
...
- [TD dla pola](../TD-014_DANE_TESTOWE/TD-014-0009__currentshipment-city.md)
