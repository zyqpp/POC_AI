...
| Nazwa wykryta | `navigate isAgent() ?` |
...
Nawigacja warunkowa zależna od roli: Agent jest przekierowywany do /shipments/:shipmentId, inne role do /orders/:id. Czysta nawigacja routerLink.
