# ERR-018-0002 Reminder workflow updated, but notification dispatch failed
...
| Atrybut | Wartość |
|---|---|
| ID błędu | `ERR-018-0002` |
| Ekran | [E-018](../E-018__README.md) |
| Nazwa wykryta | `Reminder workflow updated, but notification dispatch failed` |
