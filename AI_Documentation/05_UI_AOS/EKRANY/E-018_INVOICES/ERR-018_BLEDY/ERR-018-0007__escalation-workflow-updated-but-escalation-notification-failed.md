# ERR-018-0007 Escalation workflow updated, but escalation notification failed
...
| Atrybut | Wartość |
|---|---|
| ID błędu | `ERR-018-0007` |
| Ekran | [E-018](../E-018__README.md) |
| Nazwa wykryta | `Escalation workflow updated, but escalation notification failed` |
| Typ detekcji | `toast.error` |
| Źródło | `supply-chain-frontend/src/app/features/payments/invoice-list/invoice-list.component.ts` |
...
- [Indeks błędów](ERR-018__INDEX.md)
