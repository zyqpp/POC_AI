# ERR-018-0005 Failed to move selected invoices to disputed workflow
...
| Atrybut | Wartość |
|---|---|
| ID błędu | `ERR-018-0005` |
| Ekran | [E-018](../E-018__README.md) |
| Nazwa wykryta | `Failed to move selected invoices to disputed workflow` |
