# ERR-018-0012 `Failed to move ${invoice.invoiceNumber} to disputed workflow`
...
| Atrybut | Wartość |
|---|---|
| ID błędu | `ERR-018-0012` |
| Ekran | [E-018](../E-018__README.md) |
| Nazwa wykryta | ``Failed to move ${invoice.invoiceNumber} to disputed workflow`` |
