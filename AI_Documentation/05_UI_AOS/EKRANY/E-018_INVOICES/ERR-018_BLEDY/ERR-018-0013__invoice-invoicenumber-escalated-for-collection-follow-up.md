# ERR-018-0013 `${invoice.invoiceNumber} escalated for collection follow-up`
...
| Atrybut | Wartość |
|---|---|
| ID błędu | `ERR-018-0013` |
| Ekran | [E-018](../E-018__README.md) |
| Nazwa wykryta | ``${invoice.invoiceNumber} escalated for collection follow-up`` |
