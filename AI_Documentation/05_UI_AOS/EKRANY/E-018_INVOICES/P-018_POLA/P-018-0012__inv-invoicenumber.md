...
| Nazwa wykryta | `inv.invoiceNumber` |
...
Numer faktury — unikalny identyfikator czytelny dla człowieka, np. `INV-2024-0001`. Wyświetlany w kolumnie "Invoice #" tabeli listy faktur z klasą `fw-600`. Używany jako kryterium wyszukiwania (searchQuery filtruje po `invoiceNumber.toLowerCase()`).
...
| Typ UI | tekst tylko do odczytu (interpolacja w td) | `supply-chain-frontend/src/app/features/payments/invoice-list/invoice-list.component.html` |
...
| Encja/model | `Invoice` w PaymentInvoice domain | `wniosek z analizy` |
...
- [TD dla pola](../TD-018_DANE_TESTOWE/TD-018-0012__inv-invoicenumber.md)
