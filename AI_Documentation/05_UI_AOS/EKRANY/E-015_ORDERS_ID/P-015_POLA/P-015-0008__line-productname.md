...
| Nazwa wykryta | `line.productName` |
| Typ detekcji | `interpolation` |
| Źródło | `supply-chain-frontend/src/app/features/orders/order-detail/order-detail.component.html` |
...
| Typ UI | do uzupełnienia | `supply-chain-frontend/src/app/features/orders/order-detail/order-detail.component.html` |
| Reguły walidacji | do uzupełnienia | brak pełnej analizy walidatorów |
| Komunikaty błędów | [ERR-015](../ERR-015_BLEDY/ERR-015__INDEX.md) | do uzupełnienia |
...
- [TD dla pola](../TD-015_DANE_TESTOWE/TD-015-0008__line-productname.md)
- Zakres danych poprawnych: do uzupełnienia.
- Zakres danych błędnych: do uzupełnienia.

## Linki

- [Indeks pól](P-015__INDEX.md)
- [Akcje ekranu](../A-015_AKCJE/A-015__INDEX.md)
- [Ślad ekranu](../E-015__LINKI.md)
